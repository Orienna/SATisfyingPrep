...
//              Text(answerMessage7) //Q1
              ...
              NavigationLink(destination: FifthViewofMathQuizworking()) {
                Text("Next Page")
